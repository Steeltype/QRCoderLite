...
namespace Steeltype.QRCoderLite.Tests
{
    ...
    public class MailTests
    {
        ...
        [Fact]
        [Category("PayloadGenerator/Mail")]
        public void mail_should_build_type_mailto_empty_subject_and_message()
        {
            // string.IsNullOrEmpty guards drop empty parts entirely - no dangling '?'.
            var receiver = "john@doe.com";
            var encoding = PayloadGenerator.Mail.MailEncoding.MAILTO;

            var generator = new PayloadGenerator.Mail(receiver, subject: "", message: "", encoding: encoding);
        ...
        [Fact]
        [Category("PayloadGenerator/Mail")]
        public void mail_should_build_type_MATMSG_null_subject_and_message()
        {
            // EscapeInput normalizes null to string.Empty, so the fields render empty
            // instead of throwing.
            var receiver = "john@doe.com";
            var encoding = PayloadGenerator.Mail.MailEncoding.MATMSG;
            ...
            generator.ToString().ShouldBe("MATMSG:TO:john@doe.com;SUB:;BODY:;;");
        }
        ...
        [Fact]
        [Category("PayloadGenerator/Mail")]
        public void mail_should_build_type_SMTP_null_subject_and_message()
        {
            var receiver = "john@doe.com";
            var encoding = PayloadGenerator.Mail.MailEncoding.SMTP;
            ...
            generator.ToString().ShouldBe("SMTP:john@doe.com::");
        }
