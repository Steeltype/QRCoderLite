...
namespace Steeltype.QRCoderLite.Tests
{
    ...
    public class SMSTests
    {
        ...
        [Fact]
        [Category("PayloadGenerator/SMS")]
        public void sms_should_not_add_unused_params_SMS_iOS()
        {
            var number = "01601234567";

            var generator = new PayloadGenerator.SMS(number, PayloadGenerator.SMS.SMSEncoding.SMS_iOS);
        ...
        [Fact]
        [Category("PayloadGenerator/SMS")]
        public void sms_should_build_type_SMSTO_without_message()
        {
            // SMSTO always emits the trailing colon; with no message the text part is empty.
            var number = "01601234567";

            var generator = new PayloadGenerator.SMS(number, PayloadGenerator.SMS.SMSEncoding.SMSTO);

            generator.ToString().ShouldBe("SMSTO:01601234567:");
        }

        [Fact]
        [Category("PayloadGenerator/SMS")]
        public void sms_should_url_encode_body()
        {
            var number = "01601234567";
            ...
            generator.ToString().ShouldBe("sms:01601234567?body=Hello%20%26%20Welcome%21");
        }
    }
}
